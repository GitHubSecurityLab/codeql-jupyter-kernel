 ...
 * considered part of the public API, and may change without notice.
 */
export declare type IOPubMessageType = 'clear_output' | 'comm_close' | 'comm_msg' | 'comm_open' | 'display_data' | 'error' | 'execute_input' | 'execute_result' | 'shutdown_reply' | 'status' | 'stream' | 'update_display_data' | 'debug_event';
/**
 * Stdin message types.
 */
export declare type StdinMessageType = 'input_request' | 'input_reply';
/**
 * Jupyter message types.
 */
export declare type MessageType = IOPubMessageType | ShellMessageType | ControlMessageType | StdinMessageType;
/**
 ...
 */
export declare type IShellControlMessage = IShellMessage | IControlMessage;
/**
 ...
 */
export declare type Status = 'unknown' | 'starting' | 'idle' | 'busy' | 'terminating' | 'restarting' | 'autorestarting' | 'dead';
/**
 ...
 */
declare type ReplyContent<T> = T | IReplyErrorContent | IReplyAbortContent;
/**
 ...
 */
declare type IExecuteReplyBase = IExecuteCount & IReplyOkContent;
/**
