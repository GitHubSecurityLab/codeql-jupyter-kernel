...
let Popover = class Popover extends AbstractPureComponent2 {
    ...
    popoverRef = Utils.createReactRef();
    static defaultProps = {
    ...
    handlePopoverRef = refHandler(this, "popoverElement", this.props.popoverRef);
