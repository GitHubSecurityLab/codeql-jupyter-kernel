...
var TagInput = /** @class */ (function (_super) {
    ...
    function TagInput() {
        ...
        _this.handleRef = (0, common_1.refHandler)(_this, "inputElement", _this.props.inputRef);
        _this.addTags = function (value, method) {
            ...
            if (common_1.Utils.isFunction(onChange)) {
                shouldClearInput = onChange(tslib_1.__spreadArray(tslib_1.__spreadArray([], values, true), newValues, true)) !== false && shouldClearInput;
            }
    ...
    TagInput.displayName = "".concat(props_1.DISPLAYNAME_PREFIX, ".TagInput");
