...
MultiSliderHandle.displayName = "".concat(props_1.DISPLAYNAME_PREFIX, ".MultiSliderHandle");
var MultiSlider = /** @class */ (function (_super) {
    ...
    function MultiSlider() {
        ...
        _this.canHandleTrackEvent = function (event) {
            ...
            return !_this.props.disabled && target.closest(".".concat(common_1.Classes.SLIDER_HANDLE)) == null;
        };
    ...
    MultiSlider.prototype.render = function () {
        var _a;
        var _this = this;
        var classes = (0, classnames_1.default)(common_1.Classes.SLIDER, (_a = {},
            _a[common_1.Classes.DISABLED] = this.props.disabled,
            _a["".concat(common_1.Classes.SLIDER, "-unlabeled")] = this.props.labelRenderer === false,
    ...
    MultiSlider.prototype.renderLabels = function () {
        ...
        var labels = values.map(function (step, i) {
            var offsetPercentage = (0, sliderUtils_1.formatPercentage)((step - min) / (max - min));
    ...
    MultiSlider.prototype.renderTrackFill = function (index, start, end) {
        ...
        var startOffset = (0, sliderUtils_1.formatPercentage)(startRatio);
        var endOffset = (0, sliderUtils_1.formatPercentage)(1 - endRatio);
        ...
        var classes = (0, classnames_1.default)(common_1.Classes.SLIDER_PROGRESS, common_1.Classes.intentClass(this.getTrackIntent(start, end)));
    ...
    MultiSlider.prototype.renderHandles = function () {
        ...
        return handleProps.map(function (_a, index) {
            ...
            return (React.createElement(handle_1.Handle, { className: (0, classnames_1.default)((_b = {},
    ...
    MultiSlider.prototype.nearestHandleForValue = function (handles, getOffset) {
        return (0, sliderUtils_1.argMin)(handles, function (handle) {
    ...
    MultiSlider.displayName = "".concat(props_1.DISPLAYNAME_PREFIX, ".MultiSlider");
