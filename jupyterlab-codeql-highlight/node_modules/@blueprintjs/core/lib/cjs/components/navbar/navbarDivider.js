...
var NavbarDivider = /** @class */ (function (_super) {
    ...
    NavbarDivider.prototype.render = function () {
        ...
        return React.createElement("div", tslib_1.__assign({ className: (0, classnames_1.default)(common_1.Classes.NAVBAR_DIVIDER, className) }, htmlProps));
    };
    NavbarDivider.displayName = "".concat(props_1.DISPLAYNAME_PREFIX, ".NavbarDivider");
